...
| 2 | Світлодіоди **5 мм** | Індикація системного статусу та живлення |
...
| 3 | Клеми **DG301-5.0-02P-12-02A** | Підключення замка, кнопки, живлення 12V |
...
Вставте кабель у роз'єм RJ45. Пристрій отримає IP через **DHCP** автоматично — жодних ручних налаштувань. Після успішного підключення:
- системний LED світиться **постійно** 🔆
...
Корпус розроблено у **Fusion 360** та надруковано на 3D-принтері.

<!-- TODO: Заміни посилання на актуальний шлях до файлів моделі (папка в репо / Printables / Thingiverse) -->
📥 **[Завантажити файли 3D-моделі (STL / STEP)](3D_Models/)**
...
├── Docs/                        # Фото, схема, зображення для README
├── LICENSE                      # MIT
└── README.md
```
